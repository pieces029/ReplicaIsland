...
public final class ButtonConstants {
    ...
    // Use deprecated methods because this needs to support older applications
    public static final int MOVEMENT_SLIDER_REGION_WIDTH = ((WindowManager) ReplicaIslandApplication.getInstance().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getWidth() / 2;
    public static final int MOVEMENT_SLIDER_REGION_HEIGHT = ((WindowManager) ReplicaIslandApplication.getInstance().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getHeight();;
